...
const routes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: 'Blog',
                meta: {name: '博客信息'},
                component: () => import('../views/manager/Blog')
            },
            {
                path: 'activity',
                name: 'Activity',
            ...
            },
            {
                ...
                name: 'Report',
                meta: {name: '举报处理'},
                component: () => import('../views/manager/Report')
            },
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: 'NewBlog',
                meta: {name: '博客编辑'},
                component: () => import('../views/front/NewBlog')
            },
        ]
    },
...
// 路由守卫：后台管理区域需要登录且角色为 ADMIN；前台允许匿名浏览
router.beforeEach((to, from, next) => {
  const user = JSON.parse(localStorage.getItem('xm-user') || '{}')
  // 登录/注册页与 404 页面放行
  if (to.path === '/login' || to.path === '/register' || to.name === 'NotFound') {
    next()
    return
  }
  // 前台页面允许匿名浏览
