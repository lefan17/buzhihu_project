<template>
  <div class="container">
    <div style="width: 400px; padding: 30px; background-color: rgba(255,255,255,.8); border-radius: 5px;">
      <div style="text-align: center; font-size: 20px; margin-bottom: 20px; color: #333">欢迎注册不知乎网络论坛</div>
      <el-form :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item size="medium" prop="confirmPass">
